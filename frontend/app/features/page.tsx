...
const colorMap: Record<string, { bg: string; text: string; border: string }> = {
  ...
  slate:  { bg: "bg-slate-500/10",  text: "text-slate-300",  border: "group-hover:border-slate-400/30" },
};
            ...
            {features.map((feat, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group p-7 rounded-2xl bg-slate-900/60 border border-white/5 ${c.border} hover:bg-slate-900 transition-all duration-300`}
                >
      ...
      <section className="py-24 border-t border-white/5 text-center">
        <div className="container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-slate-400 mb-8 text-lg">Join thousands of drivers already using ParkFlow AI across India.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="px-8 py-4 rounded-xl border border-white/15 text-slate-300 hover:bg-white/5 font-semibold text-sm transition-all"
              >
                View Pricing
              </button>
            </div>
